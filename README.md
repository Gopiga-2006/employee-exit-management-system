...
| EMAIL_PROVIDER | OTP delivery mode: `console`, `resend`, or `smtp` | Production |
| RESEND_API_KEY | API key for Resend HTTPS email delivery | Production when using Resend |
...
| SMTP_USERNAME | SMTP account username | When using SMTP |
| SMTP_PASSWORD | SMTP account password or app password | When using SMTP |
| SMTP_FROM | Sender address for OTP email | When using SMTP |
